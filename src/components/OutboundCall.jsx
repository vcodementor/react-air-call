    ...
    return (
        <div className="call-icon">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 426.808 426.808" enableBackground="new 0 0 426.808 426.808;">
                <path fill="#009688;" d="M373.344,288.355c-24.696,0.048-49.241-3.856-72.704-11.563c-10.971-3.821-23.156-1.241-31.637,6.699
...
z"/>
                <g>
                    <path fill="#455A64;" d="M416.011,149.475c-5.891,0-10.667-4.776-10.667-10.667V21.475H288.011
